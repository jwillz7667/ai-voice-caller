...
export const RealtimeLogs = ({ logs, fullPage = false }: { logs: LogEntry[], fullPage?: boolean }) => {
  ...
  const getTypeColor = (type: string) => {
    const typeMap: Record<string, string> = {
      ...
      "session.created": "bg-blue-100 text-blue-800",
      "session.updated": "bg-blue-100 text-blue-800",
      "response.audio.delta": "bg-green-100 text-green-800",
      "response.output_audio.delta": "bg-green-100 text-green-800",
      "response.audio.done": "bg-green-100 text-green-800",
      "response.output_audio.done": "bg-green-100 text-green-800",
      "response.text.delta": "bg-yellow-100 text-yellow-800",
      "response.output_text.delta": "bg-yellow-100 text-yellow-800",
      "response.output_audio_transcript.delta": "bg-orange-100 text-orange-800",
      "response.output_audio_transcript.done": "bg-orange-100 text-orange-800",
      "conversation.item.create": "bg-purple-100 text-purple-800",
      "conversation.item.created": "bg-purple-100 text-purple-800",
      "conversation.item.deleted": "bg-purple-100 text-purple-800",
      "input_audio_transcription.delta": "bg-orange-100 text-orange-800",
      "input_audio_buffer.speech_started": "bg-teal-100 text-teal-800",
      "input_audio_buffer.speech_stopped": "bg-teal-100 text-teal-800",
      "input_audio_buffer.cleared": "bg-teal-100 text-teal-800",
      "input_audio_buffer.timeout_triggered": "bg-teal-100 text-teal-800",
      ...
      "response.created": "bg-green-100 text-green-800",
      "response.done": "bg-green-100 text-green-800",
      "response.output_item.added": "bg-green-100 text-green-800",
      "response.output_item.done": "bg-green-100 text-green-800",
      "response.function_call_arguments.delta": "bg-indigo-100 text-indigo-800",
      "response.function_call_arguments.done": "bg-indigo-100 text-indigo-800",
      "response.tool_call_arguments.delta": "bg-indigo-100 text-indigo-800",
      "response.tool_call_arguments.done": "bg-indigo-100 text-indigo-800",
      "response.mcp_call.in_progress": "bg-indigo-100 text-indigo-800",
      "response.mcp_call.completed": "bg-indigo-100 text-indigo-800",
      "response.mcp_call_arguments.delta": "bg-indigo-100 text-indigo-800",
      "response.mcp_call_arguments.done": "bg-indigo-100 text-indigo-800",
      "mcp_list_tools.in_progress": "bg-indigo-100 text-indigo-800",
      "mcp_list_tools.completed": "bg-indigo-100 text-indigo-800",
